...
from obj_fun import rastrigin as obj
from obj_fun import rastrigin_grad as obj_grad

import numpy as np
import matplotlib.pyplot as plt

# create SUSD optimizer with objective function
susd_opt = susd_optimizer(obj, alpha=5E-3, max_iter=50)
...
# search
susd_it, susd_hist = susd_opt.search(x0, term_len=2000)

print "Search took", susd_it, "iterations"
...
# search
gd_it, gd_hist = gd_opt.search(x0, term_grad=0.1)
